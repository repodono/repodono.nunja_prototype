define([
    ...
    'text!repodono.nunja.molds/navtable/template.jinja'
], function(core) {
    'use strict';

    window.mocha.setup('bdd');

    describe('Basic repodono.nunja.molds/navtable rendering', function() {
        beforeEach(function() {
            ...
            document.body.innerHTML = (
                '<div data-nunja="repodono.nunja.molds/navtable"></div>');
        ...
        it('Null rendering', function() {
            var results = this.engine.render('repodono.nunja.molds/navtable', {
                'active_columns': [],
                'column_map': {},
                'data': [],
                'css': {},
